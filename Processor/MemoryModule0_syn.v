...
//altsyncram CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone IV E" ENABLE_RUNTIME_MOD="NO" INIT_FILE="MemoryModule0.mif" NUMWORDS_A=64 OPERATION_MODE="SINGLE_PORT" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="CLOCK0" POWER_UP_UNINITIALIZED="FALSE" read_during_write_mode_port_a="NEW_DATA_NO_NBE_READ" WIDTH_A=8 WIDTH_BYTEENA_A=1 WIDTHAD_A=6 address_a clock0 data_a q_a wren_a
...
module  MemoryModule0_altsyncram
	( 
	address_a,
	clock0,
	data_a,
...
`endif
	...
	defparam
		...
		ram_block1a_0.init_file = "MemoryModule0.mif",
	...
	defparam
		...
		ram_block1a_1.init_file = "MemoryModule0.mif",
	...
	defparam
		...
		ram_block1a_2.init_file = "MemoryModule0.mif",
	...
	defparam
		...
		ram_block1a_3.init_file = "MemoryModule0.mif",
	...
	defparam
		...
		ram_block1a_4.init_file = "MemoryModule0.mif",
	...
	defparam
		...
		ram_block1a_5.init_file = "MemoryModule0.mif",
	...
	defparam
		...
		ram_block1a_6.init_file = "MemoryModule0.mif",
	...
	defparam
		...
		ram_block1a_7.init_file = "MemoryModule0.mif",
...
endmodule //MemoryModule0_altsyncram
//VALID FILE
...
`endif
	...
	MemoryModule0_altsyncram	MemoryModule0_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.data_a (data),
				.wren_a (wren),
